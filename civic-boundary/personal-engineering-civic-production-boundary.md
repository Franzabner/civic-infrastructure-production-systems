...
```mermaid
flowchart TD
  A["Franzabner personal engineering proof"] --> B["Synthetic civic production categories"]
  B --> C["Assumptions and QA limits"]
  C --> D["Public/private/sealed checklist"]
  D --> E["Human review hold"]
  F["Foundation authority"] -. "not represented by this artifact" .-> E
  G["Operational programs"] -. "held out" .-> E
```
